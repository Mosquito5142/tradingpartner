...
export default async function ProfilePage() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Banner>
        ⚠️ เว็บนี้<b>เปิดสาธารณะและไม่มีระบบล็อกอิน</b> — ใครที่มีลิงก์ก็เห็นยอดเงินและประวัติเทรดของคุณได้
        เลขบัญชีจึงแสดงแค่ 4 ตัวท้าย ถ้าไม่อยากให้ใครเห็นเลย ควรตั้ง Password Protection
